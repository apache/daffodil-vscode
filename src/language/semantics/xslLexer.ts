...
export class XslLexer {
            ...
            case XMLCharState.lStEq:
              ...
              if (isNativeElement) {
                ...
                if (attName === 'saxon:options') {
                  ...
                  (tagGlobalInstructionType === GlobalInstructionType.Include ||
                    tagGlobalInstructionType ===
                      GlobalInstructionType.Import) &&
                  (attName === 'href' ||
                    (this.languageConfiguration.docType === DocumentTypes.DCP &&
                      this.languageConfiguration.linkElementAttrNames &&
                      attName ===
                        this.languageConfiguration?.linkElementAttrNames[1]))
                ) {
                  isExpandTextAttribute = false
  ...
  protected getElementProperties(
    ...
    if (this.languageConfiguration.docType === DocumentTypes.DCP) {
      if (
        this.languageConfiguration.variableElementNames &&
        this.languageConfiguration.variableElementNames.indexOf(elementName) !==
          -1
      ) {
        instructionType = GlobalInstructionType.Variable
      }
      if (
        instructionType === GlobalInstructionType.Unknown &&
        this.languageConfiguration.linkElementAttrNames &&
        this.languageConfiguration.linkElementAttrNames[0] === elementName
      ) {
