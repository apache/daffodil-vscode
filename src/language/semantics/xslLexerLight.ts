        ...
        if (nextState === currentState) {
          ...
          switch (nextState) {
            ...
            case XMLCharState.lEn:
              if (
                xmlElementStack === 1 ||
                (xmlElementStack === 2 && tokenChars.length < 5)
              ) {
                tokenChars.push(currentChar)
                storeToken = true
              } else {
            ...
            case XMLCharState.lStEq:
              ...
              if (
                (tagGlobalInstructionType === GlobalInstructionType.Include ||
                  tagGlobalInstructionType === GlobalInstructionType.Import) &&
                attName === 'href'
              ) {
            ...
            case XMLCharState.escSqAvt:
              if (isGlobalInstructionName || isGlobalInstructionMode) {
                ...
                let targetGlobal = isGlobalInstructionMode
                  ? this.globalModeData
                  : this.globalInstructionData
