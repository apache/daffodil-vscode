...
// prettier-ignore
export const attributeCompletion = (additionalItems, nsPrefix: string, dfdlPrefix: string, spacingChar: string) => {
  return {
    items: [
      {
        item: 'name',
        snippetString: spacingChar + 'name="$1"$0',
        markdownString: 'specify name',
      },
      {
        item: 'ref',
        snippetString: spacingChar + 'ref="$1"$0',
        markdownString: 'specify reference name'
      },
      {
        item: 'minOccurs',
        snippetString: spacingChar + 'minOccurs="${1|0,1|}"$0',
      ...
      {
        item: 'dfdl:byteOrder',
        snippetString: spacingChar + dfdlPrefix + 'byteOrder="${1|bigEndian,littleEndian|}"$0',
        markdownString: 'This property applies to all Number, Calendar (date and time), and Boolean types with representation binary',
      },
      {
        item: 'dfdl:bitOrder',
        snippetString: spacingChar + dfdlPrefix + 'bitOrder="${1|mostSignificantBitFirst,leastSignificantBitFirst|}"$0',
        markdownString: 'Determines the specific bits of any grammar region',
      },
      {
        item: 'dfdl:occursCountKind',
        snippetString: spacingChar + dfdlPrefix + 'occursCountKind="${1|expression,fixed,implicit,parsed,stopValue|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'lengthKind="${1|delimited,fixed,explicit,implicit,prefixed,pattern,endOfParent|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'prefixIncludesPrefixLength="${1|yes,no|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'utf16Width="${1|fixed,variable|}"$0',
        markdownString: 'Specifies whether the encoding UTF-16 is treated as a fixed or variable width encoding',
      },
      {
        item: 'dfdl:encoding',
        snippetString: spacingChar + dfdlPrefix + 'encoding="${1|US-ASCII,ASCII,UTF-8,UTF-16,UTF-16BE,UTF-16LE,ISO-8859-1|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'encodingErrorPolicy="${1|error,replace|}"$0',
      ...
      {
        item: 'dfdl:nilKind',
        snippetString: spacingChar + dfdlPrefix + 'nilKind="${1|literalCharacter,literalValue,logicalValue|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'nilValueDelimiterPolicy="${1|initiator,terminator,both,none|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'useNilForDefault="${1|yes,no|}"$0',
      ...
      {
        item: 'dfdl:alignment',
        snippetString: spacingChar + dfdlPrefix + 'alignment="${1|1,2,implicit|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'lengthUnits="${1|bits,bytes,characters|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'alignmentUnits="${1|bits,bytes|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'outputNewLine="${1|%CR;,%LF;,%CR;%LF;,%NEL;,%LS;|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'representation="${1|binary,text|}"$0',
        markdownString: 'Identifies the physical representation of the element as text or binary',
      },
      {
        item: 'dfdl:textStringJustification',
        snippetString: spacingChar + dfdlPrefix + 'textStringJustification="${1|left,right,center|}"$0',
        markdownString: 'Specifies the string justification',
      },
      {
        item: 'dfdl:textStringPadCharacter',
        snippetString: spacingChar + dfdlPrefix + 'textStringPadCharacter="$1"$0',
        markdownString: 'Specifies the string justification',
      },
      {
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'textStandardInfinityRep="Inf"$0',
        markdownString: 'The value used to represent infinity.',
      },
      {
        item: 'dfdl:textStandardExponentRep',
        snippetString: spacingChar + dfdlPrefix + 'textStandardExponentRep="E"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'textNumberPattern="#,##0.###;-#,##0.###"$0',
        markdownString: 'Indicates whether an xs:decimal element is signed',
      },
      {
        item: 'dfdl:decimalSigned',
        snippetString: spacingChar + dfdlPrefix + 'decimalSigned="${1|yes,no|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'textNumberRep="${1|standard,zoned|}"$0',
        markdownString: 'Represented as standard characters in the character set encoding or represented as a zoned decimal in the character set encoding',
      },
      {
        item: 'dfdl:textNumberJustification',
        snippetString: spacingChar + dfdlPrefix + 'textNumberJustification=${1|left,right,center|}"$0',
        markdownString: 'Controls how the data is padded or trimmed on parsing and unparsing',
      },
      {
        item: 'dfdl:textNumberRoundingMode',
        snippetString: spacingChar + dfdlPrefix + 'textNumberRoundingMode="${1|roundCeiling,roundFloor,roundDown,roundUp,roundHalfEven,roundHalfDown,roundHalfUp,roundUnnecessary|}"$0',
        markdownString: 'Specifies how rounding occurs during unparsing',
      },
      {
        item: 'dfdl:textNumberRoundingIncrement',
        snippetString: spacingChar + dfdlPrefix + 'textNumberRoundingIncrement="0"$0',
        markdownString: 'Specifies the rounding increment to use during unparsing',
      },
      {
        item: 'dfdl:textNumberRounding',
        snippetString: spacingChar + dfdlPrefix + 'textNumberRounding="${1|explicit,pattern|}"$0',
        markdownString: 'Specifies how rounding is controlled during unparsing',
      },
      {
        item: 'dfdl:textNumberCheckPolicy',
        snippetString: spacingChar + dfdlPrefix + 'textNumberCheckPolicy="${1|lax,strict|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'textTrimKind="${1|none,padChar|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'textBooleanJustification="${1|left,right,center|}"$0',
        markdownString: 'Controls how the data is padded or trimmed on parsing and unparsing',
      },
      {
        item: 'dfdl:textBooleanPadCharacter',
        snippetString: spacingChar + dfdlPrefix + 'textBooleanPadCharacter="$1"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'truncateSpecifiedLengthString="${1|no,yes|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'SequenceKind ="${1|ordered,unordered|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'separatorPosition="${1|infix,postfix,prefix|}"$0',
        markdownString: 'specifies where the separator occurs between the elements',
      },
      {
        item: 'dfdl:separatorSuppressionPolicy',
        snippetString: spacingChar + dfdlPrefix + 'separatorSuppressionPolicy="${1|anyEmpty,never,trailingEmpty,trailingEmptyStrict|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + 'dfdl:hiddenGroupRef="$1"$0',
        markdownString: 'Reference to a global model group definition',
      },
      {
        item: 'dfdl:choiceLengthKind',
        snippetString: spacingChar + dfdlPrefix + 'choiceLengthKind="${1|explicit,implicit|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'ignoreCase="${1|no,yes|}"$0',
      ...
      },
       {
        ...
        snippetString: spacingChar + dfdlPrefix + 'initiatedContent="${1|yes,no|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'binaryNumberRep="${1|binary,packed,bcd,ibm4690Packed|}"$0',
      ...
      },
      {
      ...
      },
       {
        ...
        snippetString: spacingChar + dfdlPrefix + 'binaryFloatRep="${1|ieee,ibm390Hex|}"$0',
        markdownString: 'ieee or ibm390Hex',
      },
      {
        item: 'dfdl:binaryDecimalVirtualPoint',
        snippetString: spacingChar + dfdlPrefix + 'binaryDecimalVirtualPoint="$1"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'binaryPackedSignCodes="$1"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'calendarPatternKind="${1|explicit,implicit|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'calendarCheckPolicy="${1|strict,lax|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'calendarObserveDST="${1|yes,no|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'calendarFirstDayOfWeek="${1|Monday,Sunday|}"$0',
        markdownString: 'The day of the week upon which a new week is considered to start',
      },
      {
        item: 'dfdl:calendarDaysInFirstWeek',
        snippetString: spacingChar + dfdlPrefix + 'calendarDaysInFirstWeek="${1|1,2,3,4,5,6,7|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'calendarCenturyStart="$1"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'emptyValueDelimiterPolicy="${1|initiator,terminator,both,none|}"$0',
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'emptyElementParsePolicy="${1|treatAsAbsent,treatAsEmpty|}"$0',
        markdownString: 'Indicates which of initiator, terminator, both, or neither must be present when an element in the data stream is empty.',
      },
      {
      ...
      },
      {
        ...
        snippetString: spacingChar + dfdlPrefix + 'escapeKind="${1|escapeCharacter,escapeBlock|}"$0',
      ...
      },
      {
        ...
        markdownString: "The string of characters that denotes the beginning of a sequence of characters escaped by a pair of escape strings",
      },
      {
        item: 'dfdl:escapeBlockEnd',
        snippetString: spacingChar + dfdlPrefix + 'escapeBlockEnd="$1"$0',
        markdownString: "The string of characters that denotes the end of a sequence of characters escaped by a pair of escape strings",
      },
      {
        item: 'dfdl:escapeEscapeCharacter',
        snippetString: spacingChar + dfdlPrefix + 'escapeEscapeCharacter="$1"$0',
        markdownString: "Specifies one character that escapes an immediately following dfdl:escapeCharacter",
      },
      {
        item: 'dfdl:extraEscapedCharacters',
        snippetString: spacingChar + dfdlPrefix + 'extraEscapedCharacters="$1"$0',
        markdownString: "A whitespace separated list of single characters that must be escaped in addition to the in-scope delimiters",
      },
      {
        item: 'dfdl:generateEscapeBlock',
        snippetString: spacingChar + dfdlPrefix + 'generateEscapeBlock="${1|always,whenNeeded|}"$0',
        markdownString: "The type of escape mechanism defined in the escape scheme",
      },
      {
        item: 'dfdl:escapeCharacterPolicy',
        snippetString: spacingChar + dfdlPrefix + 'escapeCharacterPolicy="${1|all,delimiters|}"$0',
        markdownString: "The type of escape mechanism defined in the escape scheme",
      },
      {
        item: 'testKind',
