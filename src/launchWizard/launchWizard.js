...
function updateInfosetOutputType() {
    ...
    var infosetSelectedValue = infosetSelectionBox.options[infosetSelectionBox.selectedIndex].value

    if (infosetSelectedValue === 'file') {
        document.getElementById("infosetOutputFilePathLabel").style = "margin-top: 10px; visibility: visible;"
    } else {
        document.getElementById("infosetOutputFilePathLabel").style = "visibility: hidden;"
    }
}
...
function updateSelectedConfig() {
    ...
    if (configSelectedValue === 'New Config') {
        document.getElementById("nameLabel").style = "margin-top: 10px; visibility: visible;"
    } else {
        document.getElementById("nameLabel").style = "visibility: hidden;"
    }

    let configIndex = configSelectedValue === 'New Config' ? -1 : configSelectionBox.selectedIndex
