...
export function checkForRootNamespaceItems(
  ...
  return possibleRootNamespaces.map((prn) =>
    getSimpleCompletionItem(prn, position)
  )
}

export function getRootNamespaceCompletionProviders() {
  return [
    vscode.languages.registerCompletionItemProvider(
      { language: 'jsonc' },
      {
        provideCompletionItems(
          ...
          return checkForRootNamespaceItems(document, position)
        },
      },
      '"' // trigger
    ),
