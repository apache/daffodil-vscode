...
Place the cursor at line 11 column 44, after alignmentUnits="bytes" press the backspace key until alignmentUnits="bytes" is erased. Type CTRL+space. Select dfdl:alignmentUnits from the dropdown and bytes from the value dropdown.
\[ \] Verify that alignmentUnits="bytes" is inserted.
\[ \] Verify that alignmentUnits does not have the dfdl: prefix.

Place the cursor on line 28, column 28 at the end of the line \<xs:group
...
Place the cursor at line 30, column 18 at the end of the line
...
Place cursor at line 38, column 39 at the end of the line \<xs:element
...
Place the cursor at line 39 and hover over the attribute dfdl:alignment.
\[ \] Verify a text box appears with a definition for dfdl:alignment.

Place the cursor at line 39 column 47, with the double quotes with the value 1 for dfdl:alignment.
Type CTRL+space.
\[ \] Verify the dropdown contains 1, 2, and implicit.

Place the cursor at line 39 column 65, after dfdl:length="10". Type CTRL+space. Select dfdl:byteOrder from the dropdown and bigEndian for the value.
...
Place cursor at line 49, column 26, after \</xs:element\>. Type a space.
\[ \] Verify the dropdown contains xs:annotation, xs:choice, xs:element
name, dfdl:element ref, and xs:sequence.

Place the cursor at line 50, column 42 after \<xs:element
...
Place the cursor at line 50 column 98, within the double quotes containing the value binary for dfdl:representation. Type CTRL+space.
\[ \] Verify the dropdown contains binary an text. Select "text" as the value.
\[ \] verify that "binary" is replaced with "text".

Place the cursor at line 50 column 252 at the end of the line. Backspace over the last 2 characters "/>". The cursor shoul;d be directly after dfdl:length="{../../Length - fn:string-length(../Keyword) - 2}". Type a / (slash '/').
\[ \] Verify that the self closing tag "/> was added to the end of the line.

Place cursor at line 51, column 25, before \</xs:sequence\>. Type CTRL+space.
\[ \] Verify the dropdown contains xs:annotation, xs:choice, xs:element
name, dfdl:element ref, and xs:sequence.

Place a cursor at line 53 column 20, after \</xs:element\>. Backspace until the closing element tag is erased (line 53, column 7). Type > (the greater than symbol).
\[ \] Verify the \</xs:element\> tag is replaced.

Place the cursor at line 55 column 129, before \<xs:annotation\>. Type CTRL+space.
\[ \] Verify the dropdown contains xs:annotation, xs:complexType, xs:complexType name=,xs:simpleType, and xs:simpleType name=.

Place the cursor at liine 55 column 263, after \</xs:annotation\>. Backspace to remove the annoation closing tag. With your cursor just after the \</xs:appinfo\> tag, type > (the greater than symbol).
\[ \] Verify the closing tag for annotation is re-created in teh proper place.

# The following test use the file: src/test/data/helloWorldPlusLongForm.dfdl.xsd

Place the cursor at line 13 column 32, backspace over the two slashes ('/'). Type 2 slashes.
\[ \] Verify that typing the slashes does not erase any of the data in quotes

Place the cursor at line 15 column 39, after ref="GeneralFormat". Type a space.
\[ \] Verify the dropdown contains dfdl:alignment, dfdl:alignmentUnits,
dfdl:binaryBooleanFalseRep, dfdl:binaryBooleanTrueRep,
dfdl:binaryNumberRep, dfdl:bitOrder, dfdl:byteOrder,
dfdl:choiceBranchKey, dfdl:encoding, dfdl:inputValueCalc, dfdl:lenght,
...
Place the cursor at line 17 column 1. Type CTRL+space.
/[ /] Verify the dropdown contais dfdl:defineSscapeTheme, dfdl:defineFormat, dfdl:defineVariable,and dfdl:format.

Place the cursor at line 36 column 56 at the end of the line. Backspace over the last two characters "/>". The cursor should be directly after encoding="ascii". Type a / (slash '/').
\[ \] Verify the self closing tag characters "/>" appear at the end of the line.

Place the cursor at line 43, column 46, after representation="text". Type a space.
\[ \] Verify the dropdown contains dfdl:alignment, dfdl:alignmentUnits,
dfdl:binaryBooleanFalseRep, dfdl:binaryBooleanTrueRep,
dfdl:binaryNumberRep, dfdl:bitOrder, dfdl:byteOrder,
dfdl:choiceBranchKey, dfdl:encoding, dfdl:inputValueCalc, dfdl:lenght,
...
Place the cursor at line 52 column 49, after <xs:appinfo source="http://www.ogf.org/dfdl/v1.0">. Type CTRL+space.
/[ /] Verify the dropdown contains dfdl:assert, dfdl:discriminator, dfdl:element, dfdl:property, and dfdl:setVariable.
